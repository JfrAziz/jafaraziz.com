...
![900kb geojson to 30kb png](./1-900kb-geojson-to-30kb-png.png)
...
![real case when this method is used](./2-real-case-when-this-method-is-used.png)
...
![example when this method give bad result](./3-example-when-this-method-give-bad-result.png)
