...
![Earthquake and Volcanos data](./1-earthquake-and-volcanos-data.png)
...
![Processing Toolbox Window](./2-processing-toolbox-window.png)
...
![Join Attributes By Nearest Window](./3-join-attributes-by-nearest-window.png)
...
![Joined Layer Attributes Table](./4-joined-layer-attributes-table.png)
...
![Joined Layer Geometry Generator Symbol](./5-joined-layer-geometry-generator-symbol.png)

Apply and now you can see the line from any earthquake to it's nearest volcano.

![Final Result of Drawing Line](./6-final-result-of-drawing-line.png)
