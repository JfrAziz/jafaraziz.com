...
![Setup Disk, RAM, and EFI Support](./1-setup-disk-ram-and-efi-support.png)
...
![This PC Can't Run Windows 11](./2-this-pc-cannot-run-windows-11-error.png)
...
![Setup Disk, RAM, and EFI Support](./3-edit-vm-configuration.png)
...
![Iso not loaded](./4-iso-not-loaded.png)
...
![Installation Started](./5-windows-installation-started.png)
