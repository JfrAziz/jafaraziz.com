...
![Gnome Boxes Version](./1-gnome-boxes-version.png)
...
![Storage Limit of VM Clone](./2-storage-limit-of-vm-clone.png)
...
![Unallocated Partition on Disk Management](./4-unallocated-partition-on-disk-management.png)
...
![Insert GParted Live CD](./5-insert-gparted-live-cd-to-cd-rom.png)
...
![Move Windows Recovery Partition](./8-move-windows-recovery-partition.png)
...
![Extend C partition](./9-extend-c-partition.png)
...
![GParted Operations](./10-gparted-operations.png)
...
![Final Disk Management](./11-final-disk-management.png)
